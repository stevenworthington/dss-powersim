...
If we call `parameter_search()` it will return a single replications worth of simulations for each combination of parameter values in `pgrid`.
...
<img src="figures/unnamed-chunk-25-1.png" width="768" />
